...
Set the argument `-x | --threads` to speed up the processing time. You should choose the number of threads based on the number of processor cores on your machine. Reasonable numbers go from 2 to 8 threads. 
